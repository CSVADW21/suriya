...
void setupGUI(){
  ...
  sliders[si++] = controlP5.addSlider("motion_radius",1.0,5.0,left,top+posY+0,len,15);
  posY += 30;

  sliders[si++] = controlP5.addSlider("m",500,6000,left,top+posY+0,len,15);
  posY += 30;
  
  sliders[si++] = controlP5.addSlider("delay_factor",1.0,5.0,left,top+posY+0,len,15);
  posY += 30;
  
  sliders[si++] = controlP5.addSlider("numFrames",1.0,500.0,left,top+posY+0,len,15);
  posY += 30;
